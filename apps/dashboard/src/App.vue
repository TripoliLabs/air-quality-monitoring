...
const breadcrumbs = computed((): Breadcrumb[] => {
  ...
  if (name === 'dashboard') {
    ...
    const neighborhood = sensorsStore.getNeighborhood(id);
    const neighborhoodName =
      locale.value === 'ar' ? (neighborhood?.nameAr ?? id) : (neighborhood?.name ?? id);
    ...
    const sensorName =
      locale.value === 'ar' ? (sensor?.definition.nameAr ?? id) : (sensor?.definition.name ?? id);
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-3">
            <RouterLink to="/" class="flex items-center gap-3 transition-opacity hover:opacity-80">
              ...
              <span class="text-lg font-bold tracking-tight text-gray-100"> Qalawun </span>
            </RouterLink>
          </div>
          ...
          <div class="flex items-center gap-3">
            ...
            >
              <span class="h-2 w-2 rounded-full" :style="{ backgroundColor: aqiColor }"></span>
              {{ cityAqi }} {{ aqiLabel }}
            </div>
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-3">
          ...
          <div>
            ...
            <div class="mt-3 flex items-center gap-2">
              ...
              <span class="text-sm font-semibold text-gray-200"> Project Qalawun </span>
            </div>
