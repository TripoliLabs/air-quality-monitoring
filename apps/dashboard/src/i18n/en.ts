  ...
  featuresPage: {
    ...
    upcoming: {
      ...
      alerts: {
        ...
        description: 'Configurable AQI thresholds with email, SMS, and push notification alerts.',
      },
      openaq: {
      ...
      reports: {
        ...
        description: 'Downloadable weekly and monthly air quality reports with trend analysis.',
      },
      api: {
        title: 'Public API',
        description:
