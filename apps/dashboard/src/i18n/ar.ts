...
export default {
  ...
  featuresPage: {
    ...
    features: {
      ...
      maps: {
        title: 'خرائط تفاعلية',
        description: 'خرائط مدعومة بـ MapLibre GL JS مع علامات ملونة حسب AQI وتجميع وحدود الأحياء.',
      },
      network: {
        title: 'شبكة متعددة الأجهزة',
        description: '52 جهاز استشعار عبر 10 أحياء توفر تغطية شاملة على مستوى المدينة.',
      },
      bilingual: {
        title: 'دعم ثنائي اللغة',
        description: 'دعم كامل للعربية والإنجليزية مع تخطيط RTL ومحتوى محلي وتبديل اللغة.',
      },
      solar: {
        title: 'تعمل بالطاقة الشمسية',
        description:
    ...
    upcoming: {
      mobile: {
        title: 'تطبيق الهاتف',
        description: 'تطبيق أصلي لـ iOS و Android مع إشعارات فورية وتنبيهات بناءً على الموقع.',
      },
      alerts: {
      ...
      openaq: {
        title: 'تكامل OpenAQ',
        description: 'مشاركة تلقائية للبيانات مع منصة OpenAQ العالمية لجودة الهواء لتأثير أوسع.',
      },
      reports: {
        title: 'تقارير تاريخية',
        description: 'تقارير أسبوعية وشهرية قابلة للتحميل عن جودة الهواء مع تحليل الاتجاهات.',
      },
      api: {
  ...
  apiDocs: {
    ...
    comingSoon: 'واجهة البرمجة العامة قيد التطوير حالياً. فيما يلي معاينة للنقاط النهائية المخططة.',
